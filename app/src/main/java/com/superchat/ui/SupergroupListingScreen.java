...
public class SupergroupListingScreen extends Activity implements OnClickListener, OnItemClickListener {
	...
	ArrayList<String> ownerDomainDisplayNameSet = null;
	ArrayList<String> invitedDomainDisplayNameSet = null;
	ArrayList<String> joinedDomainDisplayNameSet = null;
...
//			countryCode = bundle.getString(Constants.COUNTRY_CODE_TXT);
			...
			groupList = bundle.getString("groupList");
...
////			orientation = Integer.parseInt(exifJpeg.getAttribute(ExifInterface.TAG_ORIENTATION));
	...
	private void registerUserOnServer(String super_group, String sg_display_name, View view) {
		...
		if (joinedDomainNameSet != null && joinedDomainNameSet.size() > 0) {
			for (int i = 0; i < joinedDomainNameSet.size(); i++) {
				domainNameSet.add("" + joinedDomainNameSet.get(i).getDomainName());
			}
		}
...
//						registerUserOnServer(superGroupName, view);
	...
	public class SignupTaskOnServer extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			Log.e(TAG, "SignupTaskOnServer :: request:" + JSONstring);
			String url = Constants.SERVER_URL + "/tiger/rest/user/register";
			Log.e(TAG, "SignupTaskOnServer :: url:" + url);
...
//						    System.out.println("SERVER RESPONSE STRING: " + entity.getContent());
						...
						if (str != null && !str.equals("")) {
							Log.e(TAG, "SignupTaskOnServer ::  response:" + str);
							str = str.trim();
