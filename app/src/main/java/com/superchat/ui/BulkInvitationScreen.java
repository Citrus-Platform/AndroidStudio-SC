...
//					adapter.addAll(listClone);
        ...
        cbMakeSuperAdmin = (CheckBox) inviteMenualDialog.findViewById(R.id.cbMakeSuperAdmin);
...
//		copyTextLable.setPadding(30, 0, 0, 0);
            ...
            case R.id.id_invite_btn:
                ...
                if(cbMakeSuperAdmin != null){
                    if(cbMakeSuperAdmin.isChecked()){
                        memberDetail1.makeSubAdmin = true;
                    } else {
                        memberDetail1.makeSubAdmin = false;
                    }
                }
